...
PanelResourceManagerUnused::PanelResourceManagerUnused()
{
	enabled = false;
}
...
void PanelResourceManagerUnused::Draw()
{
	...
	ImGui::Text("UID");				ImGui::SameLine(); ImGui::NextColumn();
	ImGui::Text("Name");			ImGui::SameLine(); ImGui::NextColumn();
	ImGui::Text("File");			ImGui::SameLine(); ImGui::NextColumn();
	ImGui::Text("Exported File");	ImGui::SameLine(); ImGui::NextColumn();
	ImGui::Text("References");		ImGui::SameLine(); ImGui::NextColumn();
	ImGui::Text("Type");			ImGui::SameLine(); ImGui::NextColumn();
...
void PanelResourceManagerUnused::UpdateResourcesList()
{
	resourcesList = App->resManager->GetUnusedResourcesList();
}

void PanelResourceManagerUnused::OpenResourceEditor()
{
	if (openEditor)
	{
...
void PanelResourceManagerUnused::DrawResourceTexture()
{
...
void PanelResourceManagerUnused::DrawResourceModel()
{
...
void PanelResourceManagerUnused::DrawResourceMesh()
{
...
void PanelResourceManagerUnused::DrawResourceAudio()
{
...
void PanelResourceManagerUnused::DrawResourceScene()
{
...
void PanelResourceManagerUnused::DrawResourceAnimation()
{
...
void PanelResourceManagerUnused::DrawResourceMaterial()
{
...
void PanelResourceManagerUnused::DrawResourceSkybox()
{
...
void PanelResourceManagerUnused::DrawResourceSM()
{
...
void PanelResourceManagerUnused::DrawResourcePrefab()
{
...
void PanelResourceManagerUnused::CleanUp()
{
	if(!openResourceWindow)
		previous = nullptr;
